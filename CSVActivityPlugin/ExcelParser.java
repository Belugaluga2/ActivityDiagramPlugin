...
public class ExcelParser {
    ...
    private static boolean isWholeIntegerName(String name) {
    	return WHOLE_INT_PATTERN.matcher(name).find();
    }
    
    private static boolean isDecimalName(String name) {
    	return DECIMAL_INT_PATTERN.matcher(name).find();
    }
    ...
    private ActivityData parseRow(Row row, Map<String, Integer> columnIndices) {
        ...
        String actor = getCellValue(row.getCell(actorIndex)).trim();
